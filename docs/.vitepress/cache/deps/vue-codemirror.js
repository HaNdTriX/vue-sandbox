...
function stringCursor(spec, state, from, to) {
  ...
  return new SearchCursor(state.doc, spec.unquoted, from, to, spec.caseSensitive ? void 0 : (x2) => x2.toLowerCase(), test);
}
...
var lintConfig = Facet.define({
  combine(input) {
    return {
      sources: input.map((i) => i.source).filter((x2) => x2 != null),
      ...combineConfig(input.map((i) => i.config), {
        ...
        hideOn: (a, b) => !a ? b : !b ? a : (t, x2, y2) => a(t, x2, y2) || b(t, x2, y2),
        autoPanel: (a, b) => a || b
      })
    };
  }
...
// node_modules/.pnpm/vue-codemirror@6.1.1_codemirror@6.0.2_vue@3.5.30_typescript@5.9.3_/node_modules/vue-codemirror/dist/vue-codemirror.esm.js
